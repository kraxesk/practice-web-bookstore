...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<h1>Регистрация:</h1>
	Полное Имя:<br><input type="text" name="name" placeholder="Полное Имя">
	<span class="error" style="color: red; font-size: 0.8em;"><?php echo $nameErr;?></span><br><br>

	Имя пользователя:<br><input type="text" name="uname" placeholder="Имя пользователя">
	<span class="error" style="color: red; font-size: 0.8em;"><?php echo $usernameErr;?></span><br><br>

	Новый пароль:<br><input type="password" name="upassword" placeholder="Новый пароль">
	...
	Номер мобильного телефона:<br><input type="text" name="contact" placeholder="+7">
