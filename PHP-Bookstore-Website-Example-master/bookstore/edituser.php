...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	Имя:<br><input type="text" name="uname" placeholder="<?php echo $oUserName; ?>">
	...
	Номер мобильного телефона:<br><input type="text" name="contact" placeholder="<?php echo $oPhone; ?>">
